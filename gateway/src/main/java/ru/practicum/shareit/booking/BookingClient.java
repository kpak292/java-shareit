...
public class BookingClient extends BaseClient {
    ...
    public ResponseEntity<Object> approveBooking(long userId, long bookingId, boolean approval) {
        StringBuilder path = new StringBuilder("/0" + bookingId);
        path.append("?approved=")
                .append(approval);

        return patch(path.toString(), userId);
    }
}
